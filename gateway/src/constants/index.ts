...
const PROOF_STATUS_PROOF_UPLOAD_SENT = BigInt(6)
const PROOF_STATUS_PROOF_UPLOADED = BigInt(7)
const PROOF_STATUS_BREVIS_QUERY_ERROR = BigInt(8)
const PROOF_STATUS_BREVIS_REQUEST_SUBMITTED = BigInt(9)
const PROOF_STATUS_ONCHAIN_VERIFIED = BigInt(10)
