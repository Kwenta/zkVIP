  ...
  for (let [_, trades2] of map) {
    const trade = trades2.reduce((t0, t1) => {
      ...
      return {
        ...
        volume: import_ethers.BigNumber.from(t0.volume).add(t1.volume).toString(),
        feesPaid: import_ethers.BigNumber.from(t0.feesPaid).add(t1.feesPaid).toString()
      };
    });
    result.push(trade);
  }
  ...
  try {
    ...
    if (response.status === 200) {
      ...
      responseJson?.data?.futuresTrades?.forEach((element) => {
        const volume = import_ethers.BigNumber.from(element.size).abs().mul(import_ethers.BigNumber.from(element.price)).div(import_ethers.BigNumber.from("1000000000000000000"));
        trades.push({
...
var buildUserTradeVolumeFeeProofReq = async (utvf) => {
  ...
  if (unclaimableTrades.length > 4400) {
    unclaimableTrades.sort((a, b) => {
      if (import_ethers2.BigNumber.from(a.volume).gt(import_ethers2.BigNumber.from(b.volume))) {
        return -1;
      } else {
        return 1;
      }
  ...
  const account = import_ethers2.BigNumber.from(utvf.account).toHexString();
...
var _bytecode2 = "";
...
var IFeeRebateTierModule__factory = class {
  ...
  static connect(address, signerOrProvider) {
    return new import_ethers9.Contract(
      address,
      _abi7,
      signerOrProvider
    );
...
var BrevisRequest__factory = class extends import_ethers11.ContractFactory {
  ...
  static createInterface() {
    return new import_ethers11.utils.Interface(_abi9);
  }
  static connect(address, signerOrProvider) {
    return new import_ethers11.Contract(address, _abi9, signerOrProvider);
  }
};
...
var dstChainProvider = new import_ethers12.ethers.providers.JsonRpcProvider(
  process.env.DEST_RPC ?? ""
);
var sourceChainProvider = new import_ethers12.ethers.providers.JsonRpcProvider(
...
function getJSONForOrderFeeFlowTx(account, transactionReceipt) {
  ...
  transactionReceipt.logs.forEach((log, i) => {
    ...
    if (logAddress === OrderFlowFeeImposedEventContractAddress && topic0.toLowerCase() === OrderFlowFeeImposedEvent && import_ethers13.BigNumber.from(log.topics[1]).eq(import_ethers13.BigNumber.from(account))) {
    ...
    } else if (isValidPositionModifiedContract(logAddress) && topic0.toLowerCase() === DelayedOrderSubmittedEvent && import_ethers13.BigNumber.from(log.topics[1]).eq(import_ethers13.BigNumber.from(account))) {
      original.fields.push({
        contract: logAddress,
        log_index: i,
...
function getJSONForExecutionTx(account, transactionReceipt) {
  ...
  transactionReceipt.logs.forEach((log, i) => {
    ...
    if (isValidPositionModifiedContract(logAddress) && topic0.toLowerCase() === PositionModifiedEvent && import_ethers13.BigNumber.from(log.topics[2]).eq(import_ethers13.BigNumber.from(account))) {
      original.fields.push({
        contract: logAddress,
        log_index: i,
        event_id: topic0,
...
async function queryTrade(trade) {
  ...
  const receipts = await Promise.all(receiptPromises);
  var volume = import_ethers13.BigNumber.from(0);
  var fee = import_ethers13.BigNumber.from(0);
  var debugFee = "";
  for (var receiptIndex = 0; receiptIndex < receipts.length; receiptIndex++) {
    ...
    if (Number(receipt.transaction_type) === TX_TYPE_ORDER_FEE_FLOW) {
      ...
      for (var i = 1; i < data.fields.length; i += 2) {
        fee = fee.add(import_ethers13.BigNumber.from(data.fields[i].value));
        debugFee += ` fee: ${data.fields[i].value} `;
      }
    } else {
      debugFee += `tx ${receipt.tx_hash} add execution fee `;
      for (let i2 = 0; i2 < data.fields.length / 4; i2++) {
        volume = volume.add(import_ethers13.BigNumber.from(data.fields[i2 * 4 + 1].value).fromTwos(256).abs().mul(import_ethers13.BigNumber.from(data.fields[i2 * 4 + 2].value)).div(import_ethers13.BigNumber.from("1000000000000000000")));
        fee = fee.add(import_ethers13.BigNumber.from(data.fields[i2 * 4 + 3].value));
...
async function prepareNewDayTradeClaims() {
  try {
    const yesterday = Number(import_moment2.default.utc(/* @__PURE__ */ new Date()).subtract(1, "d").format("YYYYMMDD"));
    ...
    for (var i = 0; i < accountTradesList.length; i++) {
      ...
      if (claimPeriod[1].gt(import_ethers14.BigNumber.from(startBlockNumber))) {
