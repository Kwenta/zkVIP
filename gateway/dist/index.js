...
var MockFeeModule__factory = class extends import_ethers9.ContractFactory {
  constructor(...args) {
...
var dstChainProvider = new import_ethers11.ethers.JsonRpcProvider(
  process.env.DEST_RPC ?? ""
);
var sourceChainProvider = new import_ethers11.ethers.JsonRpcProvider(
...
async function prepareNewDayTradeClaims() {
  try {
    ...
    const eventStartDay = import_moment2.default.utc("20240724", "YYYYMMDD", true).utc().unix();
