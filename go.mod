...
require (
	github.com/brevis-network/brevis-sdk v0.0.0-20240809022939-bb1b8dbc1955
...
replace (
	github.com/consensys/gnark => github.com/celer-network/gnark v0.0.2-0.20240225054745-d02f18f0de79
